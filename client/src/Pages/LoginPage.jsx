...
const LoginPage = () => {
  ...
  function handleLogin(e) {
    e.preventDefault();
       ...
       showPassword?togglePasswordVisibility:showPassword;
  ...
  return (
    <div>
      <form className='max-w-[48%] mx-auto mt-32' onSubmit={handleLogin}>
        ...
        <input
          ...
          className="block mb-5 w-full py-1.5 px-2 border-2 border-solid border-gray-300 rounded-md bg-white"
        />
       <div onClick={togglePasswordVisibility} className="cursor-pointer  flex justify-center p-0.5  border-2 border-gray-300 h-9 items-center rounded-md">
